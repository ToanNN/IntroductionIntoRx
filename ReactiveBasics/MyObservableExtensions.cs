...
namespace ReactiveBasics
{
    public static class MyObservableExtensions
    {
        ...
        public static void Log(object onNextValue)
        {
            Console.WriteLine("Logging OnNext({0}) @ {1}",onNextValue,DateTime.Now);
        }

        public static void Log(Exception onErrorValue)
        {
            Console.WriteLine("Logging Error({0}) @ {1}", onErrorValue,DateTime.Now);
        }

        public static void LogComplete()
        {
            Console.WriteLine("OnCompleted @ {0}", DateTime.Now);
        }
